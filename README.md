...
- [mabittar/banking-llm](https://github.com/mabittar/banking-llm) `🐍` `☁️` `🔗` – Assistente conversacional inteligente para integração bancária, utilizando LangGraph para orquestração de fluxos com LLM. **by [@mabittar](https://github.com/mabittar)**
